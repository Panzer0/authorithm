...
UNCOMPRESSED_FILENAME_JINA = f"dataset_{SUBREDDIT_NAME}_jina.parquet.gzip"
UNCOMPRESSED_FILENAME_STYLOMETRIC_JINA = (
    f"dataset_{SUBREDDIT_NAME}_stylometric_jina.parquet.gzip"
)
...
UNCOMPRESSED_PATH_STYLOMETRIC_JINA = (
    f"datasets/{UNCOMPRESSED_FILENAME_STYLOMETRIC_JINA}"
)
